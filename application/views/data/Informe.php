         ...
         <div class="table-reponsive">
          <h1 class="text-center">Informe captura</h1>
                   ...
                   <?php 
                    ...
                    ?>
                    <tr>
                      <td><?php echo $data_registros['id_registros_app'];?></td>
                      ...
                      <td><?php echo $data_registros['inventario_inicial'];?></td>
                      <td><?php echo $data_registros['inventario_final'];?></td>
                      <td><?php echo $data_registros['resurtido'];?></td>
                      <td><?php echo $data_registros['ventas'];?></td>
                      <td><?php echo $data_registros['precio'];?></td>
                      <td><img width="20%" src="<?php echo $data_registros['img_path'];?>" align="center"></td>
                      <td><?php echo $data_registros['comentarios'];?></td>
